    ...
    return (
      <div className="box box-default">
        <div className="box-body">
          ...
          <small>
            Content in these sections will be appended to their respective
            container
          </small>
          ...
          <TextField
            ...
            rows={5}
            value={
              this.state.advanced ? this.state.advFirst : this.state.notAdvFirst
            }
            underlineStyle={
              this.state.advanced ? { borderColor: '#ff9e00' } : false
            }
            underlineFocusStyle={
              this.state.advanced ? { borderColor: '#ff9e00' } : false
            }
            floatingLabelStyle={
              this.state.advanced ? { color: '#ff9e00' } : false
            }
          ...
          <TextField
            ...
            multiLine
            value={
              this.state.advanced ? this.state.advTwo : this.state.notAdvTwo
            }
            underlineStyle={
              this.state.advanced ? { borderColor: '#ff9e00' } : false
            }
    ...
    <Breadcrumb
      path={
        <small>
          ...
          <a href="">Manage Donation Forms</a> > Donation Form Options
        </small>
      }
    />
    <ControlPanel />
