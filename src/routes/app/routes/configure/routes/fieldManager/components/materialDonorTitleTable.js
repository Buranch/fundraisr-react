...
const data = [
  createData('Suffix', 'donor-suffix', 'text input'),
  createData('First Name', 'first-name', 'text input'),
  createData('Middle Name', 'middle-name', 'text input'),
  createData('Last Name', 'last-name', 'text input'),
  createData('Nick Name', 'nick-name', 'text input'),
  createData('Maiden Name', 'maiden-name', 'text input')
];
