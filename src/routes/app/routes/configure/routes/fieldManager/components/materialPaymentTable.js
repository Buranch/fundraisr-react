...
const data = [
  createData('Payment Type', 'payment-type', 'select'),
  createData('Name on Card', 'name-on-card', 'text input'),
  createData('Card Number', 'card-number', 'radio buttons'),
  createData('CCV Number', 'ccv-number', 'radio buttons'),
  createData('Expiration Month', 'expiration-month', 'select'),
  createData('Expiration Year', 'expiration-year', 'select')
];
