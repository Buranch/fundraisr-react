...
const data = [
  createData('Age', 'age', 'text input'),
  createData('Birth Day', 'birth-day', 'text input'),
  createData('Gender', 'gender', 'radio buttons'),
  createData('Ethnicity', 'ethnicity', 'select'),
  createData('Religion', 'religion', 'text input'),
  createData('Marital Status', 'marital-status', 'select'),
  createData('Living', 'living', 'radio buttons')
];
